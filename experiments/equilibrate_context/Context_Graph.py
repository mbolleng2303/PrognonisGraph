...
def infer(MODEL_NAME, DATASET_NAME, params, net_params, dirs, last_epoch):
    ...
    try:
        ...
        # add curent node
        ref_graph = testset.graph_lists[split_number]
        save_graph = ref_graph
        ref_labels = testset.label_lists[split_number]
...
def main():
    ...
    parser.add_argument('--config', default = "C:/Users/maxim/PycharmProjects/PrognosisGraph/out/", help="Please give a config.json file with training/model/data/param details")
